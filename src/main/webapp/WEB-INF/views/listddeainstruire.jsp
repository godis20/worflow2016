...
<meta charset="utf-8" />
        <title>Demandes en attente d'instruction</title>
 ...
 <body>
    ...
    <section>
		...
		<div class="content">
			...
			<legend>Demandes en attente d'instruction </legend>
			...
			<table>
                ...
                <%-- Parcours de la liste des clients en session, et utilisation de l'objet varStatus. --%>
           		 ...
           		 <c:forEach items="${listddeainstruire}" var="mapDde" varStatus="boucle">
                	...
                	<tr class="${boucle.index % 2 == 0 ? 'pair' : 'impair'}">
			                    ...
			                    <td><c:out value="${ mapDde.besoinDemande.libelleBesoinDemande }"/></td> 
			                     ...
			                     <td class="action" align="center">
			                		...
			                		<a href="<c:url value="/instructiondemande"><c:param name="idDde" value="${mapDde.id }" /></c:url>">
			                        <img src="<c:url value="/resources/modifier.jpg"/>" alt="Instruire" /> 
			                        </a>
			                    ...
			                    <td class="document" align="center">
			                            ...
			                            <a href="<c:url value="/afficherdemandeclass"><c:param name="idDde" value="${mapDde.id }"  /></c:url>">
